  ...
  <div class="w-full p-8 bg-white border border-gray-200 rounded-2xl h-full min-h-0 flex flex-col">
    ...
    <div class="flex-1 w-full min-h-0 overflow-y-auto pr-2 pl-1">
      <div class="w-full mx-auto">
        ...
        {{-- Content blocks --}}
        <div class="grid grid-cols-2 gap-4 pb-1 items-stretch">

          {{-- Locatie (col-span-2 met links data / rechts map) --}}
          @include('hub.projects.partials.onboarding.location', [
            'project' => $project,
          ...
          {{-- Contactpersoon --}}
          @include('hub.projects.partials.onboarding.contact', [
            'project' => $project,
            'sectionWrap' => $sectionWrap,
            'sectionHeader' => $sectionHeader,
            'sectionBody' => $sectionBody,
          ...
          {{-- Makelaardij --}}
          @include('hub.projects.partials.onboarding.agency', [
            'project' => $project,
            'sectionWrap' => $sectionWrap,
            'sectionHeader' => $sectionHeader,
            'sectionBody' => $sectionBody,
