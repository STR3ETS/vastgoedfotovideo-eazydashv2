    ...
    <div class="col-span-5 flex-1 min-h-0">
        <div class="w-full p-8 bg-white border border-gray-200 rounded-4xl h-full min-h-0 flex flex-col">
            <div class="flex-1 w-full flex gap-8">
                <div class="flex-1">
                    <div class="w-full rounded-4xl p-8 bg-[#0F9B9F] flex items-center justify-between relative overflow-hidden">
                        <div>
                        ...
                        <img src="/assets/team-uitnodigen-memojis.png" class="absolute z-2 right-8 max-h-[12rem]">
                    </div>
                </div>
                <div class="bg-[#f3f8f8] w-[300px] rounded-4xl p-8">
                    ...
                    <div class="w-full rounded-4xl p-4 bg-white flex flex-col">
                        ...
                        <a href="#" class="px-3 py-2 text-white font-semibold text-sm bg-[#0F9B9F] hover:bg-[#215558] transition duration-300 w-full rounded-full text-center">Inklokken</a>
                    </div>
                </div>
            </div>
        </div>
